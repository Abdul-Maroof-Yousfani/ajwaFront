        ...
        <Stack>
            ...
            <Stack direction={'row'} gap={6} justifyContent={'space-between'}>
                <Stack width={'50%'} gap={3}>
                    <FormControl>
                        <FormLabel fontSize={'16px'} fontWeight={'500'} lineHeight={'30px'}>Discount Name</FormLabel>
                    ...
                    <FormControl>
                        <FormLabel fontSize={'16px'} fontWeight={'500'} lineHeight={'30px'}>Discount Code</FormLabel>
                        <Input background={'#F3F3F3'} border={'1px solid #B4B4B4'} py={6} type="text" placeholder="Enter Your Name" />
                    </FormControl>
                    <Box display={'flex'} gap={3}>
                        <FormControl>
                            <FormLabel fontSize={'16px'} fontWeight={'500'} lineHeight={'30px'}>Time Frame</FormLabel>
                    ...
                    <Box>
                        ...
                        <Menu w='100%' h='62px'>
                            <MenuButton background={'#F3F3F3'} border={'1px solid #B4B4B4'} textAlign={'left'} w='100%' h='50px' as={Button} rightIcon={<ChevronDownIcon />}>
                                Select Category
                            </MenuButton>
